...
const M = {
  ...
  "offsite.head": { de: "Automatisches Offsite-Backup", en: "Automatic off-site backup", es: "Copia externa automática" },
  "offsite.not_configured": {
    de: "Noch nicht eingerichtet — einmalig ein Speicherziel hinterlegen (Anleitung folgt).",
    en: "Not set up yet — add a storage target once (instructions below).",
    es: "Aún no configurada — añade un destino de almacenamiento una vez.",
  },
  "offsite.never": { de: "Noch kein Offsite-Backup gelaufen", en: "No off-site backup yet", es: "Aún no hay copia externa" },
  "offsite.files": { de: "Dateien", en: "files", es: "archivos" },
  "offsite.catching_up": { de: "holt noch auf", en: "catching up", es: "poniéndose al día" },
  "offsite.run_now": { de: "Jetzt sichern", en: "Back up now", es: "Copiar ahora" },
  "offsite.ran_ok": { de: "Gesichert — {n} neue Dateien hochgeladen.", en: "Backed up — {n} new files uploaded.", es: "Copiado — {n} archivos nuevos." },
  "offsite.ran_partial": {
    de: "{n} Dateien gesichert — der Rest folgt (nochmal klicken oder auf den nächtlichen Lauf warten).",
    en: "{n} files backed up — the rest follows (click again or wait for the nightly run).",
    es: "{n} archivos copiados — el resto sigue (haz clic de nuevo o espera al proceso nocturno).",
  },
  "offsite.hint": {
    de: "Läuft nächtlich automatisch und kopiert Fotos/Videos + Text-Snapshot in einen externen Speicher (3-2-1).",
    en: "Runs automatically each night, copying photos/videos + a text snapshot to external storage (3-2-1).",
    es: "Se ejecuta cada noche y copia fotos/vídeos + un resumen de texto a un almacenamiento externo (3-2-1).",
  },
